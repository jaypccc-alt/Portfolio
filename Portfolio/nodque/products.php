            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col">
                        <div class="mid">
                            <br>
                            <h1 style="padding-left: 55px;">Products</h3>
...
include('connection.php');
$query = "SELECT `id`,`product`, `brand`, `stock`, `price` FROM `products`";
...
while($row = mysqli_fetch_array($query_run)){
    ...
    <tr>
        ...
        <td><a class="btn btn-outline-info" href="productdetails.php?Details=<?php echo "$getId";?>">Update</a></td>
